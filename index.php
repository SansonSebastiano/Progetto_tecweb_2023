<?php
    ...
    $admin_section = "<button id=\"btn-reserved\" onclick=\"location.href='" . str_replace(DIRECTORY_SEPARATOR,"/",$admin_page_ref) . "'\" tabindex='2'>Sezione Amministratore</button>";

    $writer_section = "<button id=\"btn-reserved\" onclick=\"location.href='" . str_replace(DIRECTORY_SEPARATOR,"/",$faar_ref) . "'\" tabindex='2'>Scrivi un nuovo articolo</button>";
