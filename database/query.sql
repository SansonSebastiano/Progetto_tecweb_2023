...
FROM articolo INNER JOIN commento ON articolo.id = commento.articolo INNER JOIN utente ON commento.utente = utente.id;
    ...
    -- create view with articolo and his comments and his answers
...
-- create view with animals and his votes grouped by 'nome' and count of 'voto' (YES)
...
-- create view with animals and his votes grouped by 'nome' and count of 'voto' (NO)
CREATE VIEW vote_NO
...
-- create view with animals and his votes grouped by 'nome' and count of 'voto' (YES) and (NO)
...
-- Queries creation
    ...
    -- get all animals with his votes
SELECT nome, count(voto) FROM view_animale_voto
WHERE voto='YES'
GROUP by nome;
